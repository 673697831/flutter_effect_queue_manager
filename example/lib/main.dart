...
import 'package:flutter_effect_queue_manager/flutter_effect_queue_manager.dart';
...
class _SVGASampleScreenState extends State<SVGASampleScreen>
    with SingleTickerProviderStateMixin, EffectQueueProtocol{
  ...
  void _playAnimation() {
    FlutterEffectQueueManager.singleton.addAnimationOnTagQueue(
      tag: "123",
      delegate: this,
    );
  }

  _startAnimation({double from}) {
    if (from != null) {
      animationController.value = from;
    }
    animationController
      .forward()
      .whenComplete(() {
        FlutterEffectQueueManager.singleton.endAnimateOnTagQueue(tag: "123", client: this);
      });
  }
    ...
    return Scaffold(
      ...
      floatingActionButton: isLoading || animationController.videoItem == null
          ...
          : FloatingActionButton.extended(
              ...
              label: Text(animationController.isAnimating ? "Play" : "Play"),
